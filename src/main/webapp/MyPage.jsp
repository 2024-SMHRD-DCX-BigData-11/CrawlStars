...
<header>
	...
	<img alt="" src="images/메뉴버튼.png"  width="40px" height="40px"/>
	</a>
...
<div id="popupContainer" class="popup-container">
   ...
   <div id = "post_content">
               ...
               <h2>프로필 변경</h2>
               <p>개인 정보는 비공개로 유지하세요. 여기에 추가한 정보는 회원님의 프로필을 볼 수 있는 모든 사람에게 표시됩니다.</p>
               ...
               <img src="./ProfileImg/defaultmp.png" alt="프로필 사진" class="popup-profile-picture">
  			   ...
  			   <td>
               <button class="change-photo-btn" style="margin-left : 10px; ">사진 변경</button>
               </td>
               </tr>
               </table>
               <br>
